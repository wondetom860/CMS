                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="old" id="old" placeholder="User Name"
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="new1" id="new1" placeholder="New User Name"
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                <input type="new2" name="new2" id="new2" placeholder="Confirm"
                                    class="form-control">
                            </div>
                        </div>
