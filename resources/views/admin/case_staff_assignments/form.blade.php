<style>
    ...
    input[type=text] {
        width: 30%;
        /* Make input fields fill the available width */
        padding: 10px;
...
<div class="container-fluid ">
    <div class="form-control">
        ...
        <div class="ml-5">
            ...
            <input type="text" class="col-xs-7 mb-3" name="assigned_at" id="assigned_at" value="{{ old('assigned_at', $case_staff_assignment->assigned_at ?? '') }}">
        </div>

        <div class="ml-5">
            <label for="assigned_as">Assigned By</label>
            <input type="text" class="col-xs-7 mb-3" name="assigned_by" id="assigned_by" value="{{ old('assigned_by', $case_staff_assignment->assigned_by ?? '') }}">
        </div>
    </div>
